...
class _FlutterToggleTabState extends State<FlutterToggleTab> {
  ...
  void _setDefaultSelected() {
    ...
    for (int x = 0; x < widget.labels.length; x++) {
      _labelsNotifier.value.add(DataTab(title: widget.labels[x], isSelected: false));
    }
  }
  ...
  buildContainer(double width) => Container(
        width: width,
          ...
          gradient: LinearGradient(
            ...
            colors: widget.unSelectedBackgroundColors != null
                ? (widget.unSelectedBackgroundColors!.length == 1
                    ? [widget.unSelectedBackgroundColors![0], widget.unSelectedBackgroundColors![0]]
        ...
        child: ValueListenableBuilder(
          ...
          builder: (context, labels, _) {
            return ListView.builder(
              ...
              physics: widget.isScroll ? const BouncingScrollPhysics() : const NeverScrollableScrollPhysics(),
              ...
              itemBuilder: (context, index) {
                ...
                return ButtonsTab(
                  ...
                  selectedTextStyle: widget.selectedTextStyle ?? Theme.of(context).textTheme.bodyMedium,
                  ...
                  selectedColors: widget.selectedBackgroundColors != null
                      ? (widget.selectedBackgroundColors!.length == 1
                          ? [widget.selectedBackgroundColors![0], widget.selectedBackgroundColors![0]]
